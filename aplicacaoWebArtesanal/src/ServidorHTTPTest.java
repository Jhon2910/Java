...
public class ServidorHTTPTest {
    ...
    public static void testLerRequisicaoPOSTComCorpo() {
        ...
        try {
            ...
            throw new RuntimeException("Falha : " + e.getMessage(), e);
        }
    }
    ...
    public static void testReceptorComPOST() {
        ...
        assert "Jonathan Rodrigues".equals(paramsPOST.get("nome")) : "Erro no parâmetro 'nome'";
        assert "23".equals(paramsPOST.get("idade")) : "Erro no parâmetro 'idade'";
